...
namespace Library_Management_System
{
    ...
    {
        string connectionString = "Data Source=localhost\\SQLEXPRESS;Initial Catalog=Library_Management;Integrated Security=True;Encrypt=True;Trust Server Certificate=True";

        string? username;
        public ViewBooks(string? user)
        {
            InitializeComponent();
            HideLoading();
            username = user;
        ...
        private void ShowData()
        {
            ...
            {
                string query = @"SELECT LibraryData.BookID,
                               ...
                               ON LibraryData.CategoryID=Categories.CategoryID";
